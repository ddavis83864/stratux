...
func TestFixture_HealthyDualBand(t *testing.T) {
	...
	r := BuildHealthReport(now, uat, es, gps, gdl90, system, storage, overlay, timeHealth, timeState, ahrs, baro, fan, StorageLifecycleHealth{State: StateUnknown}, AutoRecordHealth{State: StateNotInstalled}, EpaperHealth{State: StateNotInstalled})
